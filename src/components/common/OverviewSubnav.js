    ...
    return (
        <ul className="nav nav-tabs" style={{ height: "40px" }}>
            ...
            <li className="nav-item">
                <Link className={overviewActive} to={`/${props.projID}/overview`} data-tab="0">
                    Overview
                </Link>
            </li>
            <li className="nav-item">
                <Link className={tasklistActive} to={`/${props.projID}/tasks`} data-tab="1">
                    Tasks
                </Link>
            </li>
            <li className="nav-item">
                <Link className={calendarActive} to={`/${props.projID}/calendar`} data-tab="2">
                    Calendar
                </Link>
            </li>
            ...
            <Button
                ...
                hidden={props.active === "1" ? null : true}
            >
                New Board
            </Button>
        </ul>
