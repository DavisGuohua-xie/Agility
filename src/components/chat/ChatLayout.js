        ...
        <div className={styles.layoutContainer}>
            <div className={styles.mainChatContent}>
                <div className={styles.mainChatContainer}>
                    <div>
                        <nav className={`navbar bg-light ${styles.chatContainerHeader}`} style={{justifyContent: 'flex-start'}}>
                        ...
                        <div className={styles.messageContent}>
                            {props.messageList.map((msg, index) => <ChatMessage key={index} message={msg} me={props.me}/>)}
                        </div>
                    </div>
